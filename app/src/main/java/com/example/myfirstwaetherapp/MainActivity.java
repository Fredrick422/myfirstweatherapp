package com.example.myfirstwaetherapp;
        ...
        mFusedLocationProvider.getLastLocation().addOnSuccessListener(MainActivity.this, new OnSuccessListener<Location>(){
            ...
            public void onSuccess(Location location) {
                if(location != null){
                    ...
                    updateField = findViewById(R.id.weather_icon);
    ...
    public String[] getJSONResponse(){
        ...
        try {
            if(jsonWeather != null){
                ...
                String temprature = String.format("%.0f", main.getDouble("temp")) + "'";
                String humidity = main.getString("humidity") + "%";
                String presure = main.getString("pressure") + " hPa";
                String updateOn = df.format(new Date(jsonWeather.getLong("dt")*1000));
                String iconText = setWeatherIcon(details.getInt("id"), jsonWeather.getJSONObject("sys").getLong("sunsrise")*1000, jsonWeather.getJSONObject("sys").getLong("sunset")*1000);

                jsonData[0] = city;
                jsonData[1] = description;
                jsonData[2] = temprature;
                jsonData[3] = humidity;
                jsonData[4] = presure;
                jsonData[5] = updateOn;
                jsonData[6] = iconText;
